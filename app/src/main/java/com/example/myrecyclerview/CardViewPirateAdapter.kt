...
class CardViewPirateAdapter(private val listHero: ArrayList<Pirate>) :
    RecyclerView.Adapter<CardViewPirateAdapter.CardViewViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): CardViewPirateAdapter.CardViewViewHolder {
        val view: View = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_cardview_pirate, parent, false)
        return CardViewViewHolder(view)
    }

    override fun onBindViewHolder(holder: CardViewPirateAdapter.CardViewViewHolder, position: Int) {
    ...
    inner class CardViewViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var imgPhoto: ImageView = itemView.findViewById(R.id.img_item_photo_view)
